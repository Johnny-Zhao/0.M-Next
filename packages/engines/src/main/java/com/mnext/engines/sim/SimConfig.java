...
public record SimConfig(Map<String, Object> parameters) {
  public SimConfig {
    parameters = sorted(parameters == null ? Map.of() : parameters);
  }
  ...
  private static Object sortedValue(Object value) {
    ...
    if (value instanceof List<?> values) {
      return values.stream().map(SimConfig::sortedValue).toList();
    }
    return value;
  }
}
