  ...
  views: [
    ...
    },
    {
      ...
      config: {
        ...
        columns: [
          "sku",
          "name",
          { fieldCode: "price", unit: "CNY" },
          "owner",
          "lifecycle",
        ],
        defaultSort: { fieldCode: "name", direction: "asc" },
        filterFields: ["lifecycle", "name"],
        pageSize: 25,
        title: "产品规格清单",
        emptyLabel: "暂无产品规格记录。",
      },
    ...
    { id: "view-spec-doc", exprId: "exp-spec-doc", kind: "doc", config: {} },
    {
      ...
      config: {
        ...
        defaultSort: { fieldCode: "sku", direction: "asc" },
        filterFields: ["lifecycle", "name"],
        pageSize: 25,
        title: "产品规格清单",
      },
    ...
    },
    {
      ...
      config: {
        ...
        columns: [
          ...
          "channel",
          "quote",
          { fieldCode: "amount", unit: "CNY" },
        ],
        defaultSort: { fieldCode: "name", direction: "asc" },
        filterFields: ["channel", "name"],
        pageSize: 25,
        title: "协议记录清单",
        emptyLabel: "暂无协议记录。",
      },
