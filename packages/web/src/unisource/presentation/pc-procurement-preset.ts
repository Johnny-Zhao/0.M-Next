  ...
  views: [
    {
      ...
      config: {
        ...
        columns: [
          ...
          { fieldCode: "requirement_max_total_power_w_fx", unit: "W" },
      ...
      config: {
        ...
        metrics: [
          ...
          },
          {
            ...
            label: "需求最大总功耗",
            objectTypeCode: "build_plan",
            fieldCode: "requirement_max_total_power_w_fx",
            unit: "W",
            sourceLabel: "当前真实对象",
          },
          {
        ...
        recordSeries: [
          ...
          },
          {
            ...
            objectTypeCode: "build_plan",
            labelFieldCode: "name",
            valueFieldCode: "total_power_w_fx",
          },
          {
            id: "pc-performance-series",
            title: "方案性能分",
            objectTypeCode: "build_plan",
            labelFieldCode: "name",
            valueFieldCode: "total_performance_score_fx",
          },
          {
            id: "pc-psu-series",
            title: "电源容量",
            objectTypeCode: "build_plan",
            labelFieldCode: "name",
            valueFieldCode: "power_supply_capacity_w_fx",
          },
        ],
      },
    },
          ...
          analysisQuestions: [
            {
              ...
              label: "功耗最低的方案",
              kind: "min",
              fieldCode: "totalPower",
            },
            {
              id: "pc-highest-performance",
              label: "性能最高的方案",
              kind: "max",
          ...
          outline: [
            {
              ...
              label: "采购需求",
              target: "build_plan_satisfies_requirement",
            },
            { id: "plan-overview", label: "方案概览", target: "root" },
            {
              id: "configuration",
              label: "配置明细",
              target: "build_plan_contains_item",
            },
            {
              id: "suppliers-quotes",
              label: "供应商与报价",
